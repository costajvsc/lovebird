...
<body>
    ...
    <main class="container">
        ...
        <h3>Deletar presença</h3>
        <p>Deseja realmente excluir esta presenças? #(<?= $id ?>)</p>
        <p>As seguintes informações serão perdidas</p>
        <ul>
            <li>Confirmação da presença (<i><?= $convidado ?></i>)</li>
            <li>Quantidade de adultos</li>
            <li>Quantidade de crianças</li>
            <li>Observação</li>
        </ul>
        <form action="http://localhost/casamento/controller/presencas/Delete.php" method="POST">
            <input type="hidden" name="idPresenca" value="<?= $id ?>">
            <input type="hidden" name="convidado" value="<?= $convidado ?>">
            <div class="d-flex justify-content-end">
                <a type="button" class="btn btn-dark mr-2" href="presencas.php">
