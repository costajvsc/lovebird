...
<body>
    ...
    <main class="container">
        ...
        <h3>Deletar evento #<?=$id ?></h3>
        <p>Deseja realmente excluir este evento?</p>
        <p>As seguintes informações serão perdidas</p>
        <ul>
            <li>Local do evento (<i><?= $titulo ?></i>)</li>
            <li>Data do evento</li>
            <li>Descrição</li>
            <li>Latitude e longitude</li>
            <li>Lista de convidados</li>
            <li>Comentários do evento</li>
        </ul>
        <form method="POST" action="http://localhost/casamento/controller/eventos/Delete.php">
