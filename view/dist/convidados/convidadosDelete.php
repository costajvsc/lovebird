...
<body>
    ...
    <main class="container">
        ...
        <h3>Excluir convidado #<?=$id ?></h3>
        <p>Deseja realmente excluir este convidado?</p>
        <p>As seguintes informações serão perdidas</p>
        <ul>
            <li>Nome do convidado (<i><?= $nome ?></i>)</li>
            <li>Email do convidado</li>
            <li>Senha do convidado</li>
            <li>Comentários</li>
            <li>Confirmações de presença</li>
        </ul>
        <form method="POST" action="http://localhost/casamento/controller/convidados/Delete.php">
